        ...
        <form action="{{ route('admin.assets.update', $asset) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="cab_number" class="form-control @error('cab_number') is-invalid @enderror" value="{{ old('cab_number', $asset->cab_number) }}" required>
                    @error('cab_number')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Asset Number *</label>
                    <input type="text" name="asset_number" class="form-control @error('asset_number') is-invalid @enderror" value="{{ old('asset_number', $asset->asset_number) }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" value="{{ old('designation', $asset->designation) }}" required>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity', $asset->quantity) }}" min="1" required>
                    @error('quantity')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-3 mb-3">
                    <label class="form-label">Unit Price (€)</label>
                    <input type="number" name="unit_price" step="0.01" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price', $asset->unit_price) }}">
